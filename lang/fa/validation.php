...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'stock'=>'موجودی',
        'price'=>'قیمت',
        'product_categories'=>'دسته بندی',
        'verify-code'=>'کد اعتبار سنجی',
        'amount'=>'مبلغ',
        'percent'=>'درصد',
        'color'=>'رنگ',
        'colorCode'=>'کد رنگ',
        'name_en'=>'نام لاتین',
        'brandCategories'=>'دسته بندی های برند',
        'picture'=>'تصویر',
        'tax_percent'=>'درصد مالیات',
        'fullName'=>'نام و نام خانوادگی',
        'codeMeli'=>'کد ملی',
        'mobileNumber'=>'شماره همراه',
        'backupMobileNumber'=>'موبایل پشتیبان',
        'fax'=>'نمابر',
        'confirmPassword'=>'تکرار کلمه عبور',
        'practicalUnit'=>'واحد عملی',
        'theoreticalUnit'=>'واحد نظری',
        'type'=>'نوع',
        'level'=>'سطح',
        'lang'=>'زبان',
        'certificate'=>'مدرک',
        ...
        'short_description'=>'توضیح اجمالی',
        'explain'=>'توضیحات',
